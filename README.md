...
WHERE
	...
	AND bm.updated_at BETWEEN '2022-12-01 00:00:00' 
	AND '2022-12-01 23:59:59' 
	AND mc."id" != 15107 -- toko di hindari karena bukan rekening jatim melainkan VA static
ORDER BY
	bm.updated_at ASC
```
